...
- **Fonte de dados unificada em Montserrat**: o token `--font-data` (e `--font-mono`) deixou de usar Roboto Mono — todos os valores tabulares, IDs, CNPJ, competências e hashes passam a usar Montserrat. Roboto Mono removida do carregamento `next/font`; pesos 400/500 adicionados à Montserrat.
